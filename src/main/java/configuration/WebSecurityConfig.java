...
import configuration.roles.RoleType;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String ROLES_QUERY = "SELECT username, role FROM user_role WHERE username=?";
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/assets/**", "/css/**", "/img/**", "/js/**", "/fonts/**", "/swf/**");
    }
